...
function App() {
	...
	//so that it would be simpler to set up my create forms.
	...
	//When first working on it, I passed down the set state functions; 
	//however, I realized that my components didn't need these functions,
	//as they would be using json requests.
  return (
    <>
